...
\url{https://github.com/chili-epfl/mutual-modelling-adoption-homosexuality-study}.}
...
$t=-3.3, df=60, p = 0.0016$), supporting the symmetry hypothesis.
...
$\mathcal{H}_2$               &                                  & supported                       & supported                 &                           &                              \\
...
3) question $\mathcal{H}_{3}$: if the role of the modellee was so
...
($\Delta_4$ in study 4 and study 5) could also contributes to the idea that $A$'s
