...
level of mutual modelling, i.e. that each partner needs some model of what
...
for requiring a deeper negotiation of meaning.  The craft of CSCL is to design
...
Please note that we consider the quality of interactions at triad level (ABC),
neglecting the cases where AB interact better for instance than BC, since there
...
We report five studies conducted  by different researchers in different contexts
