...
to translate their trajectories souvenir into a map drawing. However, 85% of
...
the KAT condition participants (M = 13.4\%) and the control group [M = 3.6%, t(1,
...
Rectangle question ∆4: the correlation between M(A,A) and M(A,B) is \fixme{???
MIRWEIS A FAIRE}.
